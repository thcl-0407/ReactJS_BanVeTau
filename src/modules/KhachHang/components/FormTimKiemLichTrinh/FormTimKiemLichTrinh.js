...
function FormTimKiemLichTrinh(props) {
    ...
    return (
        <div className="flex bg-white h-120">
            <div className="border border-gray-400 shadow-lg w-72">
                ...
                <div className="p-4">
                    ...
                    <div className="py-3">
                        ...
                        <div className="border">
                            <DataPicker className="p-1.5 cursor-pointer" locale="vi" selected={startDate} onChange={date => setStartDate(date)} minDate={subDays(new Date(), 0)}></DataPicker>
                        </div>
                    </div>
